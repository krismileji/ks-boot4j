 ...
 * @since 0.2.0
 */
public class DefaultCorsFilter extends CorsWebFilter implements FactoryBean<CorsWebFilter>, PriorityOrdered {
    ...
    @Override
    public CorsWebFilter getObject() {
    ...
    public static class ConfigurationSource extends UrlBasedCorsConfigurationSource {
         ...
         * 构造器
         *
         * @param corsConfiguration CORS 配置
         * @since 0.2.0
         */
