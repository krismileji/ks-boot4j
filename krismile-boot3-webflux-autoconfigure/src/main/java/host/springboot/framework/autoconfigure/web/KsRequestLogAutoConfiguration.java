...
import host.springboot.framework.context.filter.RequestLogFilter;
...
public class KsRequestLogAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public RequestLogFilter requestLogFilter(List<RequestInfoChainExecute> requestInfoChainExecutes) {
        return new RequestLogFilter(requestInfoChainExecutes);
    }
}
